...
plant_PhyEig <-data.frame(plant_tree$tip.label, plant_litter@Eigen$vectors[,1:5])
...
#round((frug_litter@Eigen$values)/sum((frug_litter@Eigen$values)),3)*100 #first three vectors contain 66.4% of variation!!!
...
round((frug_litter@Eigen$values)/sum((frug_litter@Eigen$values)),3)*100 #first three vectors contain 47% of variation
