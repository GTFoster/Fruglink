...
for(i in 1:100){
  ...
  rebalancedRF_Phy <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_phylo), PlantTraits = c(p_phylo), class_balancing = TRUE)
  rebalancedRF_Traits <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_traits), PlantTraits = c(p_traits), class_balancing = TRUE)
  rebalancedRF_Latent <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_latent), PlantTraits = c(p_latent), class_balancing = TRUE)
  rebalancedRF_PhyTraits <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_phylo, f_traits), PlantTraits = c(p_phylo, p_traits), class_balancing = TRUE)
  rebalancedRF_TraitsLatent <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_latent, f_traits), PlantTraits = c(p_latent, p_traits), class_balancing = TRUE)
  rebalancedRF_PhyLatent <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_latent, f_phylo), PlantTraits = c(p_latent, p_phylo), class_balancing = TRUE)
  rebalancedRF_Trio <- woodedWalk_NoSplit(birds_temp, FrugTraits = c(f_phylo, f_latent, f_traits), PlantTraits = c(p_phylo, p_latent, p_traits), class_balancing = TRUE)
...
save(split_output, file="fullReplicateRF.Rda")
```
